...
function ProposalItem(_a) {
    ...
    return (react_1.default.createElement("div", Object.assign({ className: (0, utils_2.cn)('divide-y divide-muted-foreground', status === 'active' && 'font-bold', isGridView && 'grid grid-cols-[25px_1fr] items-start pb-4') }, props), isGridView ? (react_1.default.createElement(card_1.Card, null,
        ...
        react_1.default.createElement(card_1.CardContent, null,
            ...
            react_1.default.createElement("p", { className: 'text-xs text-muted-foreground' }, "+20.1% from last month")))) : (react_1.default.createElement("div", { className: 'flex flex-row items-center justify-between border-b border-neutral-900 py-6 hover:cursor-pointer' },
        ...
        react_1.default.createElement("div", { className: 'flex flex-row items-center space-x-4' },
            react_1.default.createElement("div", { className: 'flex flex-row items-center space-x-2' },
                ...
                react_1.default.createElement("div", { className: 'w-24' },
                    react_1.default.createElement("div", { className: 'h-2 rounded-lg bg-neutral-900' },
                        react_1.default.createElement("div", { className: 'flex space-x-2' },
                            react_1.default.createElement("div", { className: 'h-3 rounded-md border border-green-500 bg-green-500', style: { width: `${(13 / 20) * 100}%` } }),
                            react_1.default.createElement("div", { className: 'h-3 rounded-md border border-orange-500 bg-orange-500', style: { width: `${(7 / 20) * 100}%` } }))))),
