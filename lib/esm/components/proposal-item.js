...
export function ProposalItem(_a) {
    ...
    return (React.createElement("div", Object.assign({ className: cn('divide-y divide-muted-foreground', status === 'active' && 'font-bold', isGridView && 'grid grid-cols-[25px_1fr] items-start pb-4') }, props), isGridView ? (React.createElement(Card, null,
        ...
        React.createElement(CardContent, null,
            ...
            React.createElement("p", { className: 'text-xs text-muted-foreground' }, "+20.1% from last month")))) : (React.createElement("div", { className: 'flex flex-row items-center justify-between border-b border-neutral-900 py-6 hover:cursor-pointer' },
        ...
        React.createElement("div", { className: 'flex flex-row items-center space-x-4' },
            React.createElement("div", { className: 'flex flex-row items-center space-x-2' },
                ...
                React.createElement("div", { className: 'w-24' },
                    React.createElement("div", { className: 'h-2 rounded-lg bg-neutral-900' },
                        React.createElement("div", { className: 'flex space-x-2' },
                            React.createElement("div", { className: 'h-3 rounded-md border border-green-500 bg-green-500', style: { width: `${(13 / 20) * 100}%` } }),
                            React.createElement("div", { className: 'h-3 rounded-md border border-orange-500 bg-orange-500', style: { width: `${(7 / 20) * 100}%` } }))))),
