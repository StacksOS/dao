  ...
  return (
    ...
    >
      {isGridView ? (
        ...
        <div className='flex flex-row items-center justify-between border-b border-neutral-900 py-6 hover:cursor-pointer'>
          ...
          <div className='flex flex-row items-center space-x-4'>
            <div className='flex flex-row items-center space-x-2'>
              ...
              <div className='w-24'>
                <div className='h-2 rounded-lg bg-neutral-900'>
